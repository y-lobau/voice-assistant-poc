...
export function PorcupineModule() {
	...
	function readBinary(filename) {
		...
		return fs.readFile(normalized).then((bytes) => {
			let result = bytes
			if (!bytes.buffer) {
	...
	var wasmBinaryFile = locateFile("../../../../../assets/pv_porcupine.wasm");
	...
	function createWasm() {
		...
		function instantiateWasm(receiver) {
			return readBinary(wasmBinaryFile).then((binary) => {
		...
		function instantiateAsync() {
			return instantiateWasm(receiveInstantiatedSource)
		}
